...
def box2command():
    ...
    fileout1 = 'CAfile1.p12'
    fileout2 = 'CAfile2.p12'
    fileout3 = 'CAfile3.p12'
        ...
        for line in infile:
            ...
            if counter == 1:
                if line.strip() == "-----BEGIN CERTIFICATE-----":
                    ...
                    outfile2.write(line)
    #CAfile1 REWRITE
    with open('CAfile1.p12', "r+") as f: 
        a = f.read() 
        with open('CAfile1.p12', "w+") as f: 
    ...
    #CAfile2 REWRITE
    with open('CAfile2.p12', "r+") as f: 
        a = f.read() 
        with open('CAfile2.p12', "w+") as f: 
            f.write("-----BEGIN CERTIFICATE-----")
            f.write('\n')
            f.write(a)
            with open('CAfile2.p12', "r+") as f: 
    ...
    output1 = Variable.p12CAfile1path
    output1 = re.sub('.p12', '', output1)
    codecontent1 = f'pkcs12 -in "{Variable.p12CAfile1path}" -nokeys -out "{output1}.pem"'
    ...
    time.sleep(2)
    output2 = Variable.p12CAfile2path
    output2 = re.sub('.p12', '', output2)
    codecontent2 = f'pkcs12 -in "{Variable.p12CAfile2path}" -nokeys -out "{output2}.pem"'
...
def box3command():
    ...
    with open('CAfile2.p12', "r+") as f: 
        ...
        with open('CAfile2.p12', "w+") as f: 
            ...
            with open('CAfile2.p12', "r+") as f: 
                b = f.read() 
    #CAfile3 REWRITE
    with open('CAfile3.p12', "r+") as f: 
        a = f.read() 
        with open('CAfile3.p12', "w+") as f: 
            f.write("-----BEGIN CERTIFICATE-----")
            f.write('\n')
            f.write(a)
            with open('CAfile3.p12', "r+") as f: 
    ...
    keyboard.press(Key.enter)
    time.sleep(2)
    output3 = Variable.p12CAfile3path
    output3 = re.sub('.p12', '', output3)
    codecontent3 = f'pkcs12 -in "{Variable.p12CAfile3path}" -nokeys -out "{output3}.pem"'
...
#Top Label
l = tk.Label(root, text='Type in the path to the .p12 Certificate')
l.pack()
